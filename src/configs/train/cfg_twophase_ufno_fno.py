...
model = dict(
    ...
    # alternative FNO and UFNO by stacking processor of 1 block,
    # keep same parameters for all
    hidden_blocks=1,
    processor=[dict(object="FNO"),
               dict(object="UFNO")],

    fno_modes=10,
    hidden_features=192,
    fno_kernel_size=1,
    fno_conv_mode="single",
    padding_mode="circular",

    ch_mults=[1, 1],
    is_attn=[False for _ in range(2)],
    mid_attn=False,
    norm=True,
    use1x1=True,
